...
To work with stream views, you first need to have types and streams data. 
Here's a simplified procedure for working with the stream view. For more details, the next sections. 
